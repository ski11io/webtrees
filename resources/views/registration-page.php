		...
		<form id="register-form" name="register-form" method="post" onsubmit="return checkform(this);" autocomplete="off">
			...
			<div>
				<label>
					...
					<input type="email" name="user_email" required maxlength="64" value="<?php echo escape($email); ?>">
				</label>
				<p class="small text-muted">
			...
			<div>
				<label>
					...
					<input type="text" name="user_name" required maxlength="32" value="<?php escape($username); ?>">
				</label>
				<p class="small text-muted">
